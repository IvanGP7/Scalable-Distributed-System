...
# Configuración
TEST_TEXT = "Eres un bobo y un tontolaba"
...
# Guardar resultados
result_line = f"FilterClient,{NUM_REQUESTS},{num_servers},{total_time:.4f}\n"
with open("tiempos_clientes.log", "a") as f:
    f.write(result_line)

# Mostrar resultados
print(f"FilterClient - {NUM_REQUESTS} peticiones - {num_servers} servidores")
